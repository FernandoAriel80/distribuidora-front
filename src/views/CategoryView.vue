                                    ...
                                    <div class="p-2">
                                        ...
                                        <div v-if="product.offer" class="flex items-center justify-between mb-2">
                                            <span v-if="product.type.id == 1"
                                                class="text-gray-800 font-bold text-xs">Unidad: $<p
                                                    class="line-through">{{ formatNumber(product.old_price) }}</p>
                                            </span>
                                            <span v-if="product.type.id == 2"
                                                class="text-gray-800 font-bold text-xs">Kg: $<p class="line-through">{{
                                        ...
                                        <div v-else class="flex items-center justify-between mb-2">
                                            ...
                                            <span v-if="product.type.id == 2"
                                                class="text-gray-800 font-bold text-xs">Kg: ${{
                                                    formatNumber(product.unit_price) }}</span>
                                            <span v-if="product.bulk_unit_price"
