...
<template>
  ...
  <div class="mx-6">
    <button @click="openModalCreate" class="px-4 py-2 bg-blue-500 text-white rounded">
      Cargar Producto
    </button>
    ...
    <ModalAsk
      :isOpen="showAlert"
      :closeNo="closeModalAlert"
      :closeYes="closeModalAlertYes"
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="product in products" :key="product.id">
                ...
                <td class="px-2 py-3 text-sm text-gray-500 break-words max-w-28">
                  {{ product.description }}
                </td>
                ...
                <td
                  class="px-2 py-3 text-sm text-gray-500 w-auto h-auto overflow-hidden text-center"
                >
                  <ImagePreview
                    class="w-16 h-16 max-w-16 max-h-16 object-contain"
                ...
                <td class="px-2 py-3 text-sm text-gray-500">
                  <button
                    @click="openModalAlert(product.id)"
