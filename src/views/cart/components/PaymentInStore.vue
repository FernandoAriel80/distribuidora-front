    ...
    <div class="bg-white rounded-lg shadow-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="space-y-4">
        ...
        <div class="p-4 border border-gray-300 rounded-lg">
          ...
          <p class="font-semibold mt-2">
            Dirección: Av. Juan Manuel de Rosas 11000 Gregorio de Laferrere, Argentina
          </p>
          <p>
            Horario de atención: Lunes a Viernes: 9:00 hs - 17:00 hs, Sábados: 9:00 hs -
            13:00 hs
          </p>
      ...
      <div class="space-y-4">
        ...
        <div class="p-4 border border-gray-300 rounded-lg">
          ...
          <div
            v-for="item in cartStore.formattedItems"
            :key="item.id"
