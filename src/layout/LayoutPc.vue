<script setup>
import CategoryMenu from "@/head/CategoryMenuPc.vue";
  ...
  <div>
    <header class="text-slate-600">
      <nav class="flex items-center justify-between p-2 px-10 mx-auto">
        ...
        <div v-else class="space-x-5 ml-auto flex">
          <router-link
            class="relative inline-block rounded-lg p-2 hover:bg-blue-800 hover:text-white"
            to="/"
          >
            <div>
              <img :src="logoHome" alt="Logo" class="w-8 h-8" />
            </div>
            Inicio
          </router-link>
          <router-link
          ...
          >
            <div>
              <img :src="logoInicia" alt="Logo" class="w-8 h-8" />
            </div>
            Ingresá
          </router-link>
        </div>
